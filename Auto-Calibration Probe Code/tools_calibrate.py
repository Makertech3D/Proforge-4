...
class ToolsCalibrate:
    def __init__(self, config):
        ...
        self.gcode.register_command('TOOL_CALIBRATE_TOOL_OFFSET_1', self.cmd_TOOL_CALIBRATE_TOOL_OFFSET_1,
                                    desc=self.cmd_TOOL_CALIBRATE_TOOL_OFFSET_1_help)
        self.gcode.register_command('TOOL_CALIBRATE_TOOL_OFFSET_2', self.cmd_TOOL_CALIBRATE_TOOL_OFFSET_2,
                                    desc=self.cmd_TOOL_CALIBRATE_TOOL_OFFSET_2_help)
        self.gcode.register_command('TOOL_CALIBRATE_TOOL_OFFSET_3', self.cmd_TOOL_CALIBRATE_TOOL_OFFSET_3,
                                    desc=self.cmd_TOOL_CALIBRATE_TOOL_OFFSET_3_help)
    ...
    def cmd_TOOL_CALIBRATE_TOOL_OFFSET_1(self, gcmd):
...
# Write offset values to variables.cfg
    ...
    cmd_TOOL_CALIBRATE_TOOL_OFFSET_2_help = "Calibrate tool 2 offset relative to tool 0"
    def cmd_TOOL_CALIBRATE_TOOL_OFFSET_2(self, gcmd):
        if not self.sensor_location:
            raise gcmd.error("No recorded sensor location, please run TOOL_LOCATE_SENSOR first")
        location = self.locate_sensor(gcmd)
        self.last_result=[location[i]-self.sensor_location[i] for i in range(3)]
    ...
    def cmd_TOOL_CALIBRATE_SAVE_TOOL_OFFSET(self, gcmd):
        ...
        # Write to variables.cfg
        with open("./variables.cfg", "a") as cfg_file:
            cfg_file.write("\n\n[%s]\n%s = %s" % (section_name, param_name, value))
